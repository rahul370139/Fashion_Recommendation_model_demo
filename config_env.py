...
GITHUB_REPO_SLUG = os.getenv("GITHUB_REPO_SLUG", "rahulsharma/multimodal-fashion-retrieval")
...
def validate_config():
    ...
    if issues:
        ...
        print("   export GITHUB_REPO_SLUG='your-username/repo-name'")
        print("2. Or create a .env file with these variables")
        print("3. Or update config.py with actual values")
        return False
...
# GitHub Configuration
GITHUB_REPO_SLUG=your-username/multimodal-fashion-retrieval
...
"""
    ...
    print("📝 Copy .env.template to .env and fill in your actual values")
